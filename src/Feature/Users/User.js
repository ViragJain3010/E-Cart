              ...
              <div className="flex flex-col md:flex-row justify-center align-middle md:space-x-6 space-y-4  py-6">
                ...
                <div className="flex flex-col justify-center align-middle">
                  <div className="text-xl font-medium text-gray-900">
                    {userData && (userData.name || "New User")}
                  </div>
              ...
              {userData &&
                userData.address.map((address, index) => (
                  <>
                    ...
                    >
                      <div className="flex justify-between gap-x-6 py-5 px-8 border-2 border-gray-300 m-2 rounded-lg md:w-3/5 w-full">
                      ...
                      <div className="flex rounded justify-center align-middle space-x-3 my-2 md:w-2/5">
                        <div
                          onClick={(e) => {
