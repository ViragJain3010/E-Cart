...
const AdminFilterPage = ({ children }) => {
  // REDUX STORE
        ...
        <div>
          ...
          <main className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            <div className="flex items-baseline justify-between border-b border-gray-200 pb-6 pt-24">
              <h1 className="md:text-4xl text-3xl font-bold tracking-tight text-gray-900">
                All Products
              </h1>
              ...
              <div className="flex items-center">
                ...
                <Link
                  to={"/admin/newproduct"}
                  type="button"
                  className="-m-2 ml-5 p-2 flex text-white bg-green-500 md:bg-green-500 hover:bg-green-600 rounded-md sm:ml-7"
                >
                  <PlusIcon className="flex w-6 h-6" />
